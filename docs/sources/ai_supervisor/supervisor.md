...
The 3Laws Copilot is based on Control Barrier Functions as described in " __Backup Control Barrier Functions: Formultation and Comparative Study__ , 
Yuxiao Chen1 , Mrdjan Jankovic2 , Mario Santillo2 , and Aaron D. Ames1, 
arXiv:2104.11332v1 [eess.SY] 22 Apr 2021", and " __Applied Safety Critical Control__ 
...
![CoPilot Architecture showing inputs and outputs from a typical Copilot](supervisor_architecture_1.png)
...
![CoPilot Architecture showing inputs and outputs from a typical Copilot](supervisor_architecture_1b.png)
...
[CoPilot stops a truck based on perceiving the vehicle in the next lane.](truck_stopping.mov)
