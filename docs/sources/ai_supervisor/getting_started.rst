...
The 3Laws Copilot is based on Control Barrier Functions as described in " * Backup Control Barrier Functions: Formultation and Comparative Study *, 
...
.. image: supervisor_architecture_1.png
   :width: 200px
...
.. image: supervisor_architecture_1b.png
   :width: 200px
   :alt: CoPilot Architecture showing inputs and outputs from a typical Copilot
