...
The RAM publishes a set of markers to visualize the processing done by the Safety Maps, and the safety constraints generated by the Kernel Generator:
...
This data is published on the **/lll/ram/markers** topic. The :ref:`control panel <control_panel_viz>` can provide you with a an rviz configuration file to visualize this data.

.. important::
  If the **Use Localization** setting is set to false, the robot will stay still at the center of the world, and the raw laserscan data likely won't line up with the Safety Map markers.
